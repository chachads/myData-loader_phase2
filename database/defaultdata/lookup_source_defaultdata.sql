...
INSERT INTO lookup.lookup_source(internal_source_id, source_key, source_description, temp_table_definition, stage_table_name,source_format,source_date_format) VALUES (2, 'ONQ_CRSSTAY', 'OnQ CRS stay data.', null, 'stage.stage_onq_crsstay','JSON','yyyy-MMdd');

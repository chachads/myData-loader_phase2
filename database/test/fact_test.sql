...
INSERT INTO t_row_count SELECT 'stage_onq_salt',COUNT(*) FROM stage.stage_onq_salt;
...
INSERT INTO t_row_count SELECT 'onq_salt_f',COUNT(*) FROM warehouse.onq_salt_f;

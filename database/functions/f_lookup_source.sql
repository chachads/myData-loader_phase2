...
CREATE OR REPLACE FUNCTION lookup.f_lookup_source(
    ...
    RETURNS TABLE(internal_source_id integer, source_key character varying, source_description character varying, temp_table_definition character varying, stage_table_name character varying, source_format character varying,source_date_format character varying)
    LANGUAGE 'plpgsql'
    COST 100
